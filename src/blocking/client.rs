...
impl From<Response> for ClientError {
...
impl Spotify {
    ...
    pub fn track(&self, track_id: &str) -> ClientResult<FullTrack> {
    ...
    pub fn artist(&self, artist_id: &str) -> ClientResult<FullArtist> {
    ...
    /// Parameters:
    /// - artist_id - the artist ID, URI or URL
    pub fn artist_related_artists(&self, artist_id: &str) -> ClientResult<FullArtists> {
        let trid = self.get_id(Type::Artist, artist_id);
    ...
    pub fn album(&self, album_id: &str) -> ClientResult<FullAlbum> {
    ...
    pub fn user(&self, user_id: &str) -> ClientResult<PublicUser> {
    ...
    /// - user_id - the id of the user
    /// - playlist_id - the id of the playlist
    pub fn user_playlist_unfollow(&self, user_id: &str, playlist_id: &str) -> ClientResult<String> {
    ...
    pub fn current_user_playing_track(&self) -> ClientResult<Option<Playing>> {
    ...
    pub fn audio_features(&self, track: &str) -> ClientResult<AudioFeatures> {
    ...
    pub fn audio_analysis(&self, track: &str) -> ClientResult<AudioAnalysis> {
    ...
    pub fn device(&self) -> ClientResult<DevicePayload> {
    ...
    /// Parameters:
    /// - device_id - device target for playback
    pub fn pause_playback(&self, device_id: Option<String>) -> ClientResult<()> {
    ...
    ///             Parameters:
    ///  - device_id - device target for playback
    pub fn next_track(&self, device_id: Option<String>) -> ClientResult<()> {
    ...
    /// Parameters:
    /// - device_id - device target for playback
    pub fn previous_track(&self, device_id: Option<String>) -> ClientResult<()> {
    ...
    ///  - device_id - device target for playback
    pub fn seek_track(&self, position_ms: u32, device_id: Option<String>) -> ClientResult<()> {
    ...
    ///  - device_id - device target for playback
    pub fn repeat(&self, state: RepeatState, device_id: Option<String>) -> ClientResult<()> {
        let url = self.append_device_id(
    ...
    /// - device_id - device target for playback
    pub fn volume(&self, volume_percent: u8, device_id: Option<String>) -> ClientResult<()> {
    ...
    ///  - state - true or false
    ///  - device_id - device target for playback
    pub fn shuffle(&self, state: bool, device_id: Option<String>) -> ClientResult<()> {
    ...
    pub fn add_item_to_queue(&self, item: String, device_id: Option<String>) -> ClientResult<()> {
    ...
    pub fn save_shows<'a>(&self, ids: impl IntoIterator<Item = &'a str>) -> ClientResult<()> {
    ...
    /// Query Parameters
    /// - market(Optional): An ISO 3166-1 alpha-2 country code.
    pub fn get_a_show(&self, id: String, market: Option<Country>) -> ClientResult<FullShow> {
    ...
    ///  Query Parameters
    /// - market: Optional. An ISO 3166-1 alpha-2 country code.
    pub fn get_an_episode(&self, id: String, market: Option<Country>) -> ClientResult<FullEpisode> {
    ...
    pub fn get_several_episodes<'a>(
        ...
        let url = "episodes";
        let joined_ids = ids.into_iter().collect::<Vec<&'a str>>().join(",");
        let mut params = HashMap::new();
        if let Some(_market) = market {
            params.insert("country".to_owned(), _market.as_str().to_owned());
        }
    ...
    /// Query Parameters
    /// - ids: Required. A comma-separated list of the Spotify IDs for the shows. Maximum: 50 IDs.
    pub fn check_users_saved_shows<'a>(
        &self,
        ids: impl IntoIterator<Item = &'a str>,
    ) -> ClientResult<Vec<bool>> {
    ...
    /// - market: Optional. An ISO 3166-1 alpha-2 country code.
    pub fn remove_users_saved_shows<'a>(
        &self,
        ids: impl IntoIterator<Item = &'a str>,
        market: Option<Country>,
    ) -> ClientResult<()> {
