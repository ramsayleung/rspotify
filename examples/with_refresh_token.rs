...
async fn do_things(spotify: Spotify) {
    let artists = vec![
        Id::from_id(Type::Artist, "3RGLhK1IP9jnYFH4BRFJBS").unwrap(), // The Clash
        Id::from_id(Type::Artist, "0yNLKJebCb8Aueb54LYya3").unwrap(), // New Order
        Id::from_id(Type::Artist, "2jzc5TC5TVFLXQlBNiIUzE").unwrap(), // a-ha
    ];
    spotify
